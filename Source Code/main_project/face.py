...
# Load a second sample picture and learn how to recognize it.
pranav_image = face_recognition.load_image_file("pranav.jpg")
pranav_face_encoding = face_recognition.face_encodings(pranav_image)[0]

# Load a second sample picture and learn how to recognize it.
ishika_image = face_recognition.load_image_file("ishika.jpg")
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            pil_image.save( './data/' +str(count) +'Unknown.jpg')
            count += 1
